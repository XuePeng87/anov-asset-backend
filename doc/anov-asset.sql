...
CREATE TABLE `asset_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='资产类型表';
...
CREATE TABLE `asset_loan` (
  ...
  `modify_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='资产领用表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `asset_scraps`
--
...
--
-- Dumping data for table `asset_scraps`
--

LOCK TABLES `asset_scraps` WRITE;
/*!40000 ALTER TABLE `asset_scraps` DISABLE KEYS */;
/*!40000 ALTER TABLE `asset_scraps` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `asset_status_log` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='资产状态变更记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_auth_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统认证日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_operate_log` (
  ...
  `exe_time` bigint NOT NULL DEFAULT '0' COMMENT '执行时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_operate_log_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统操作日志详情表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-12 12:33:00
